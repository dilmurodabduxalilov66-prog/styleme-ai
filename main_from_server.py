...
async def try_on(request: TryOnRequest, http_request: Request, current_user: CurrentUser = Depends(get_current_user)):
    ...
    target_image_path = os.path.join(os.getcwd(), "reference_styles", f"style_{style_id}.jpg")
    ...
    try:
        ...
        try:
            ...
            STYLE_YOUR_HAIR_VERSION = "71501c0c6600a941548e6f1f4560a6b7dbebc84d"

        print(f"[*] Calling Replicate API cjwbw/style-your-hair for sync TryOn {analysis_id}...")
        ...
        result_filename = f"{analysis_id}_style_{style_id}_sync.jpg"
