...
async function runTests() {
  ...
  await pool.query(`INSERT INTO users (id, phone, role) VALUES ('barber_1', '+998901234567', 'BARBER') ON CONFLICT DO NOTHING`);
  await pool.query(`INSERT INTO barber_profiles (user_id) VALUES ('barber_1') ON CONFLICT DO NOTHING`);
